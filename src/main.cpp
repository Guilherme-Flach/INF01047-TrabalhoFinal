...
int main(int argc, char *argv[]) {
    ...
    const BezierPath_Quadratic lensPathToPanoramic = {
        {player.get_playerCamera().get_fov(), player.get_playerCamera().get_nearPlane(),
    ...
    const BezierPath_Quadratic lensPathToPlayer = {
        ...
        {player.get_playerCamera().get_fov(), player.get_playerCamera().get_nearPlane(),
         player.get_playerCamera().get_farPlane(), 1.0f},
        {0.1 * M_PI, player.get_playerCamera().get_nearPlane(), player.get_playerCamera().get_farPlane(),
         1.0f}};
